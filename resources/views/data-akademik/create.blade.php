    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h2>Create Data Akadmemik Siswa</h2>
      ...
      <div class="row">
        ...
        @endif
            <form action="{{ url('/dataakademik/create/aksi') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body form-container">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="perkembangan_fisik" class="form-control"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="perkembangan_kognitif" class="form-control"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="perkembangan_sosial_emosional" class="form-control"></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="perkembangan_bahasa" class="form-control"></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <textarea name="kegiatan_belajar" class="form-control"></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                   ...
                   <select name="semester" class="form-control">
                    <option>Pilih Semeseter Sekarang</option>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="nilai_fisik">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="nilai_sosial">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="nilai_belajar">
