...
<body class="hold-transition sidebar-mini">
  <a href="{{ route('showGuru') }}" class="btn btn-danger" style="margin: 30px;"><i class="fa-solid fa-arrow-left"></i></a>
  <div class="wrapper">
              ...
              <div class="card-body form-container">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="nip" value="{{ old('nip', $guru->nip) }}">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="tgl_lahir" value="{{ old('tgl_lahir', $guru->tgl_lahir) }}" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask>
                ...
                <div class="form-group">
                  ...
                  <img src="{{ asset('storage/guru/'. $guru->foto) }}" alt="foto" width="100">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select name="jenkel" class="form-control" value="{{ old('jenkel', $guru->jenkel) }}">
