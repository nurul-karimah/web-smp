      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-danger">
            ...
            <form action="{{url('/registerGuru/create')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body form-container">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="tgl_lahir" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask>
                    @error('tgl_lahir')
                    <div>
                      {{ $message }}
                    </div>
